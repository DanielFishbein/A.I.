...
# Soemthing is up with the plotting of this section but the idea is that the NN can be very confident in its desision but still wronge
...
# Grab an image from the test test_dataset
img = test_images[0]
print(img.shape)
img = np.array([img])
print(img.shape)
